...
/// <summary>
/// Shape rules for <see cref="LoginUserCommand"/>: both fields must be present, and nothing else.
/// </summary>
/// <remarks>
/// <para>
/// This is intentionally far weaker than <see cref="RegisterUserCommandValidator"/>, and the
